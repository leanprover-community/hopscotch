...
The concrete fix that repairs the two-step module-deprecation failure described
at the top of this file. The pure string helpers are factored out so they can be
unit-tested without any filesystem or network access.
-/
